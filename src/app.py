...
activities = {
    ...
    "Art Club": {
        "description": "Exploring visual arts, painting, and mixed media projects",
    ...
    "Science Club": {
        "description": "Hands-on experiments, labs, and science fair projects",
...
# New: allow unregistering (remove) a participant from an activity
@app.delete("/activities/{activity_name}/participants")
def unregister_participant(activity_name: str, email: str):
    """Unregister a student (remove their email) from the specified activity.

    Use: DELETE /activities/{activity_name}/participants?email=student@example.com
    """
    if activity_name not in activities:
        raise HTTPException(status_code=404, detail="Activity not found")
